...
const { minute } = require('../lib/parsers/minute');
...
describe('minute()', () => {
  describe.each([
    [
      'en-US',
      'Sun. 1/23/2222 4:30pm',
      '2-digit',
      { name: '30', style: '2-digit' },
    ],
    ...
    ['en-GB', '31-1-20 06:01PM', '2-digit', { name: '01', style: '2-digit' }],

    [
      'en-GB',
      'Mon. 14/1/20 3:12:23 PM',
      '2-digit',
      { name: '12', style: '2-digit' },
    ],
    ['et-EE', 'Sun. 31/12/2222 4pm', '2-digit', null],
    [
      'et-EE',
      'Sun. 31/11/3030 4:40pm',
      '2-digit',
    ...
    test(`returns ${expected}`, async () => {
      ...
      let match = await minute(values, sequence);
