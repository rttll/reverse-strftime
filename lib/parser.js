...
const getDirective = require('./parser/directive');
const getWeekday = require('./parser/weekday');
const getMonth = require('./parser/month');
const getDay = require('./parser/day');
const getYear = require('./parser/year');
